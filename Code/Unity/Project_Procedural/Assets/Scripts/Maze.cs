...
public class Maze : MonoBehaviour {
	...
	public IEnumerator Generate () {
        ...
        while (size.y-- > 0)
        {
            ...
            CreateStairs(cell, null, MazeDirection.North);
        }
	...
	private void DoNextGenerationStep (List<MazeCell> activeCells) {
		...
		IntVector3 coordinates = currentCell.coordinates + direction.ToIntVector3();
	...
	private MazeCell CreateCell (IntVector3 coordinates) {
		...
		cells[coordinates.x, coordinates.y, coordinates.z] = newCell;
    ...
    private void CreateStairs(MazeCell cell, MazeCell otherCell, MazeDirection direction)
    {
        MazeStairs stairs = Instantiate(stairsPrefab) as MazeStairs;
        stairs.Initialize(cell, otherCell, direction);
    }
