...
part_type_size(particle3,0.3,0.3,-0.001,0);
part_type_scale(particle3,0.10,0.10);
...
part_type_life(particle3,10,10);

emitter1 = part_emitter_create(Sname);
part_emitter_region(Sname,emitter1,x,x,y,y,0,0);
part_emitter_burst(Sname,emitter1,particle3,1);


part_type_step(particle3,1,particle1);
part_type_death(particle3,50,particle1);
