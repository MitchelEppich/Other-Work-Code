...
l_wall = place_meeting(x-1, y, obj_solid);// Wall on left?
r_wall = place_meeting(x+1, y, obj_solid);// Wall on right?
...
// Stealth
scr_control_stealth(key_s);

// Attack
scr_control_attack(key_w, key_d, key_a);

// Scale
scr_control_scale();

// Follow
scr_control_with(key_c);
